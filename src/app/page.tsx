...
const apps: AppData[] = [
  {
    id: 1,
    title: "AI 옷 바꾸기",
    description: "AI를 활용해 옷 스타일을 바꿔 보고 피팅 시뮬레이션처럼 활용할 수 있는 앱입니다.",
  ...
  },
  {
    id: 101,
    title: "미술 감상 · 관찰 · 프롬프트",
    description: "작품을 자세히 관찰하고 감상한 뒤 프롬프트 활동까지 이어지는 미술 수업 도구입니다.",
  ...
  },
  {
    ...
    description: "영역을 지정해 원하는 부분별로 이미지를 생성하는 AI 그림 앱입니다.",
  ...
  },
  {
    ...
    description: "사회 문제를 3D 환경에서 탐색하고 생각을 확장해 보는 민주시민 활동 앱입니다.",
  ...
  },
  {
    id: 104,
    title: "키다리샘 점검표",
    description: "기초학력 키다리샘 지도일지를 점검하고 정리하는 운영 도구입니다.",
  ...
  },
  {
    id: 105,
    title: "분반 작업 도우미",
    description: "학생 데이터를 바탕으로 분반 작업을 효율적으로 정리하는 학급 운영 도구입니다.",
  ...
  },
  {
    id: 106,
    title: "퀴즈맵 생성기",
    description: "그라운드 카드용 퀴즈 레이스 맵을 자동 생성하는 제작 도구입니다.",
    thumbnail: "",
  ...
  },
  {
    id: 107,
    title: "봄·봄·봄",
    description: "AI 융합 미술 감상 프로그램으로 살펴봄, 생각해봄, 피워봄 활동을 지원합니다.",
    thumbnail: "",
  ...
  },
  {
    id: 108,
    title: "리듬 분수 놀이",
    description: "분수 개념을 음악 리듬과 함께 재미있게 익히는 수학 앱입니다.",
